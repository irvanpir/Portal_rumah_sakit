...
<head>
  ...
  <title>SIMRS UHTP-MUHAMMAD IRVAN</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-success sticky-top shadow-sm">
  <div class="container">
    <a class="navbar-brand fw-bold" href="#">MUHAMMAD IRVAN - 24082017(TI)</a>
      ...
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="{{ route('visimisi.index') }}">Visi & Misi</a></li>
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{ route('pendaftaran.index') }}">Pendaftaran Pasien</a>
        </li>
      </ul>
    </div>
  </div>
